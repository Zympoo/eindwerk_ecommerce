...
new class extends Component
{
    ...
    protected function getCartData(): array
    {
        ...
        // 1. Ingelogde gebruiker (Database)
        if (Auth::check()) {
    ...
    public function with(): array
    {
        ...
        // Bereken de totale waarde direct mee voor de dropdown footer
...
@if($count > 0)
    <div 
        ...
        class="absolute right-0 top-full mt-2 w-72 bg-gray-800 border border-gray-700 rounded-lg shadow-xl z-50 p-3 text-sm text-white pointer-events-auto"
        x-cloak
    >
